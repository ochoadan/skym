...
| T-04.4 / R-031–R-040 — Persistent community progress | [Operation, maintenance and E-10 procedure](T-04.4/README.md) · [Sources](T-04.4/sources.md) · [Evidence](T-04.4/evidence-2026-09-23.md) | [Persistence and ownership](../ARCHITECTURE.md#4-protocol-and-persistence); [storage](../../src/Community.Server/PersistentStore.cs), [service checks](../../tests/Community.Tests/PersistenceChecks.cs) |
| T-04.5 / scoped R-015–R-020 — Automatic presentation and in-world input investigation | [Plan and acceptance](T-04.5/README.md) | [Client boundaries](../ARCHITECTURE.md#5-client-and-resource-boundaries); existing [adapter](../../src/Community.AdapterLab/probe.py), no new implementation |
